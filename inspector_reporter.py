...
class InspectorV2Findigs:
    ...
    def evaluate_findings_for_ec2(self):
        ...
        if not findings:
            return {"findings_count": {"HIGH": 0, "MEDIUM": 0, "CRITICAL": 0, "UNTRIAGED": 0, "INFORMATIONAL": 0}, "findings" : [], "scanned_at" : datetime.datetime.now(), "ec2_id": self.filter_criteria["filterCriteria"]["resourceId"][0]["value"], "tags": self.tag_value, "tag_name": self.tag_name}
